...
print("Los Jedis ordenados por nombre:")
for jedi in jedis:
    print (jedi['name'])
jedis.sort(key=by_species)
print("Los Jedis ordenados por especie: ")
for jedi in jedis:
    print ("Especie",jedi['species'],"//////// Jedi ", jedi["name"],)

print("----------PUNTO B----------")
print ("La información completa de Ahsoka Tano y Kit Fisto es:")
bus1=search(jedis,'name',"Ahsoka Tano")
print (jedis[bus1])
bus2=search(jedis,'name',"Kit Fisto")
print(jedis[bus2])


print("----------PUNTO C----------") 
for jedi in jedis:
    master_value = jedi["master"]
    if master_value is not None:
        masters = master_value.split('/')
        jedi["master"] = masters
        if "Yoda" in masters:  
            print(jedi["name"]," es padawan de Yoda")
        elif "Luke Skywalker" in masters:
            print(jedi["name"]," es padawan de Luke Skywalker")


print("----------PUNTO D----------")
print ("Los Jedi de especie humana son: ")
for jedi in jedis:
...
print("----------PUNTO F----------") 
print ("Los que usaron mas de un sable de color son: ")
for jedi in jedis:
    sable_color = jedi["lightsaber_color"]
    if sable_color is not None and '/' in sable_color:
        colores = sable_color.split('/')
        if len(colores) > 1:
            print(jedi["name"],"con sable de color: ",jedi["lightsaber_color"])

print("----------PUNTO E----------")
print ("Los Jedi usaron sable de luz amarillo o violeta son: ")
for jedi in jedis:
    if jedi['lightsaber_color']=="Purple" or jedi['lightsaber_color']=="Yellow":
        print (jedi['name'],"con sable de luz color", jedi['lightsaber_color'])
...
if master_value is not None:
    masters = master_value.split('/')
    jedi["master"] = masters
    if "Qui-Gon Jin" in masters:  
        print(jedi["name"]," es padawan de Qui-Gon Jin")
    elif "Mace Windu" in masters:
        print(jedi["name"]," es padawan de Mace Windu")
else:
    print ("No tuvieron padawans")

print("----------PUNTO I----------")
print ("Los Jedi que son Grand Master son: ")
for jedi in jedis:
